...
{
    room->front = load_texture("textures//fal.jpg");
    room->left = load_texture("textures//fal.jpg");
    room->right = load_texture("textures//fal.jpg");
    room->back = load_texture("textures//fal.jpg");
    room->top = load_texture("textures//fal.jpg");
    room->bottom = load_texture("textures//fal.jpg");
}
...
void init_entities(World *world)
{
    ...
    world->grandfatherclock.texture = load_texture("textures//grandfatherclock_uv.bmp");
     print_model_info(&(world->grandfatherclock.model));*/
